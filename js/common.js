...
//   /**
//    * Table td 선택상태 / 아닌상태로 th 체크박스 제어
//    * 2017-07-28 장민형
//    */
//   $('td input[type=checkbox]').change(function(){
//       var $table = $(this).parents('table');
//       var $cbs = $table.find("td input[type=checkbox]");
//       var $cbs_checked = $table.find("td input[type=checkbox]:checked");
      
//       if($cbs.length == $cbs_checked.length){
